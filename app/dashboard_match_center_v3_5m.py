...
# Keep the visual layout unchanged while reducing browser polling from 60s to 5m.
# The J1 scheduler remains independent and can continue running at its own cadence.
