...
TARGET_LEAGUES = {
    "br_serie_a": {
        ...
        "priority": 1,
        "aliases": ["Serie A", "Brazil Serie A", "Brasileirao Serie A", "Brasileirão Série A"],
    },
    "br_serie_b": {
        "canonical_name": "Serie B",
        "priority": 1,
        "aliases": ["Serie B", "Brazil Serie B", "Brasileirao Serie B", "Brasileirão Série B"],
    },
    "copa_do_brasil": {
    ...
    "libertadores": {
        ...
        "priority": 1,
        "aliases": ["Copa Libertadores", "Libertadores", "Libertadores da America", "Libertadores da América"],
    },
    "sudamericana": {
        "canonical_name": "Copa Sudamericana",
        "priority": 1,
        "aliases": ["Copa Sudamericana", "Copa Sulamericana", "Sudamericana", "Sul-Americana", "Copa Sul-Americana"],
    },
    "premier_league": {
        "canonical_name": "Premier League",
        "priority": 1,
        "aliases": ["Premier League", "Premiere League"],
    },
    "la_liga": {
    ...
    "champions_league": {
        "canonical_name": "Champions League",
        "priority": 1,
